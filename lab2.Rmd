...
```{r, count-SFOflights, warning=FALSE}
library("stringr")
...
```{r, arrival-distribution-histogram}
...
## 4. Response
The summary statistics calculation revealed that carrier "VX" had the most variable arrival delay.
```{r,}
sfo_feb_flights %>%
  group_by(carrier) %>%
...
## 9. Response
The estimated cutoff point for departure delays will range from zero to seventy-five that may not incurr any arrival delays. 
